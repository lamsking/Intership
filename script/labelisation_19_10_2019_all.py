...
FOLDER_PATH = "/home/inra-cirad/Bureau/MonDossier/DATA/"
...
for j in range(len(polyCoordinate)):
    ...
    for i in range(len(lineCoordinate)) : 
        ...
        if len(lineList) == 4: 
            ...
            lineList = []
    #nameImg = str(polyCoordinate.iloc[j,4])+'_'+nameId  #partie avec identification des vols
    nameImg = str(polyCoordinate.iloc[j,4])#partie sans identificationn des differents vols
